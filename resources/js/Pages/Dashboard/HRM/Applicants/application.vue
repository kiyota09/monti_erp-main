...
const filteredApplicants = computed(() => {
    return props.applicants.filter(person =>
...
const openScheduleModal = (applicant) => {
    ...
    // Set default scheduled_at to tomorrow at 9 AM
...
const submitSchedule = () => {
    ...
    scheduleForm.post(route('hrm.applicants.schedule', selectedApplicant.value.id), {
        ...
        onSuccess: () => {
            ...
            // Refresh the page to update the applicant list
...
// Helper function to format notice period for display
                ...
                <form @submit.prevent="submitSchedule" class="space-y-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 mt-1 ml-1">Earliest date based on notice period</p>
                        </div>
                        ...
                        <div>
                            <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Notes</label>
                            <textarea v-model="scheduleForm.notes" rows="3"
                                placeholder="Additional notes for the interview..."
                                class="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 resize-none"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit" :disabled="scheduleForm.processing"
                            ...
                            <span v-if="scheduleForm.processing">Scheduling...</span>
                    ...
                    <form @submit.prevent="submitForm" class="space-y-8">
                        ...
                        <div
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold text-slate-500 ml-1">Street Address Line 2</label>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold text-slate-500 ml-1">Expected Salary (PHP)</label>
                                    <input v-model="form.expected_salary" type="number" placeholder="e.g., 50000"
                                        class="w-full px-5 py-3.5 rounded-2xl bg-white dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 text-sm focus:ring-2 focus:ring-blue-600">
                                </div>
                                <div class="space-y-1.5">
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold text-slate-500 ml-1">Textile Experience *</label>
                                    <select v-model="form.textile_experience"
                                        class="w-full px-5 py-3.5 rounded-2xl bg-white dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 text-sm focus:ring-2 focus:ring-blue-600">
                                    ...
                                    <div :class="form[type + '_file'] ? 'border-emerald-500 bg-emerald-50/50' : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800'"
                                        ...
                                        <template v-if="!form[type + '_file']">
                                            ...
                                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">
                                                Click to upload</p>
                                            <p class="text-[8px] text-slate-400 mt-1">JPEG, PNG (Max 2MB)</p>
